...
fn bench_cpu_vs_gpu_ultimate(c: &mut Criterion) {
    println!("🔥🔥🔥 ULTIMATE CPU MULTICORE vs GPU FULL-BURN 🔥🔥🔥");
    println!("===================================================");
...
criterion_group!(benches, bench_cpu_vs_gpu_ultimate);
